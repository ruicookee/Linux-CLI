# Linux-CLI
Learning how to navigate Linux CLI with the help of Over The Wire Bandit! No more GUI for me!!!!!
...
| Level | Topic |
|-------|-------|
| [Level 0](OverTheWire/Bandit/Level-0.md) | SSH Login |
| [Level 0-->1](OverTheWire/Bandit/Level-0-->1.md) | ls and cat |
...
Check out [cipher.py](cipher.py)! You only need to figure out my algo for 2 parameters to crack it. And then tell me how you did it.
